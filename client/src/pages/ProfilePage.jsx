...
const ProfilePage = () => {
  ...
  return (
    ...
    justify-center'>
      <div className='w-5/6 max-w-2xl backdrop-blur-2xl text-gray text-gray-300 border-2
      ...
      rounded-lg'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
          ...
          placeholder='Write your profile bio' required className='p-2 border
          border-gray-500 rounded-md focus:outline-none focus:ring-2
          focus:ring-amber-50' rows={4}></textarea>
